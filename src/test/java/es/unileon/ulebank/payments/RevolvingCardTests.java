...
public class RevolvingCardTests {
	...
	public void setUp() throws Exception {
		...
		testCard = new RevolvingCard(handler, client, account, 400.0, 1000.0, 400.0, 1000.0, commissionEmission.getFee(0), commissionMaintenance.getFee(0), commissionRenovate.getFee(0));
	}
