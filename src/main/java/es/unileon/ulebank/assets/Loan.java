...
public class Loan implements FinancialProduct {
	...
	public Loan(Handler idLoan, double initialCapital, double interest,
		...
		try {
			...
			this.studyCommission = new LoanFee(0, false);
			this.cancelCommission = new LoanFee(0, false);
			this.modifyCommission = new LoanFee(0, false);
			this.openningCommission = new LoanFee(0, false);
			this.amortizedCommission = new LoanFee(0, false);
	...
	/**
	 * This method paid the nextsheluedPaymen,udpdate the paids and add in the taskList
	 * the task
	 * @throws LoanException
	 */
	...
	public void paid() throws LoanException {
		...
		Task task=new Task(
				this.forwardDate(this.nextPayment.getExpiration(), paymentPeriod),
