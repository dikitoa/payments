...
public class GenerateCardContractController
{
	...
	/**
	 * Constructor del controlador que recibe el validador del formulario
	 * @param generateContractValidator
	 */
	@Autowired
	public GenerateCardContractController(GenerateCardContractValidator generateContractValidator) {
		this.generateContractValidator = generateContractValidator;
	}
