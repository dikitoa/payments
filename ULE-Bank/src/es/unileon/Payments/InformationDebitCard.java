...
public class InformationDebitCard extends javax.swing.JFrame {
    ...
    public InformationDebitCard(int buyLimit, int cashLimit) {
        initComponents();
        DebitCard card = new DebitCard();
        card.setBuyLimitDiary(buyLimit);
        card.setCashLimitDiary(cashLimit);
...
//        this.jTextField8.setText(String.valueOf(card.getCommission()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformationDebitCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformationDebitCard().setVisible(true);
            }
        });
    }
