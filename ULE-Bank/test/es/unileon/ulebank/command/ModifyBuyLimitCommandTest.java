...
public class ModifyBuyLimitCommandTest {
	...
	public void testCommandNotNull() {
		test = new ModifyBuyLimitCommand(this.handler, this.account, 100.0, "diary");
		assertTrue(test != null);
	}
	
	@Test
	public void testCommandId() {
		test = new ModifyBuyLimitCommand(this.handler, this.account, 200.0, "diary");
	...
	public void testLimitDiaryNotModified() {
		test = new ModifyBuyLimitCommand(handler, account, 1100.0, "Diary");
		assertEquals(400.0, this.testCard.getBuyLimitDiary(), 0.0001);
		test.execute();
	...
	public void testLimitMonthlyModified() {
		test = new ModifyBuyLimitCommand(handler, account, 2000.0, "Monthly");
	...
	public void testLimitMonthlyNotModified() {
		test = new ModifyBuyLimitCommand(handler, account, 300.0, "Monthly");
		assertEquals(1000.0, this.testCard.getBuyLimitMonthly(), 0.0001);
		test.execute();
		assertEquals(1000.0, this.testCard.getBuyLimitMonthly(), 0.0001);
	}
	...
	public void testTypeOK() {
		test = new ModifyBuyLimitCommand(handler, account, 300.0, "DIARY");
		test.execute();
	...
	public void testTypeNotOK() {
		test = new ModifyBuyLimitCommand(handler, account, 300.0, "");
		test.execute();
		...
		test2 = new ModifyBuyLimitCommand(handler, account, 500.0, "123");
		test2.execute();
		assertEquals(400.0, testCard.getBuyLimitDiary(), 0.0001);
		assertEquals(1000.0, testCard.getBuyLimitMonthly(), 0.0001);
	}
	...
	public void undoTest() {
		test = new ModifyBuyLimitCommand(this.handler, this.account, 300.0, "diary");
		test.execute();
